...
public class PictureEditor {
    ...
    //自定义输出目录，带文件名的,如果这个设置了，那 relativePath 就会失效
    private String customOutPath;
    ...
    public String getCustomOutPath() {
        return customOutPath;
    }

    public void setCustomOutPath(String customOutPath) {
        this.customOutPath = customOutPath;
    }
