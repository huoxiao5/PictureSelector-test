...
public final class PictureSelectionModel {
    ...
    public PictureSelectionModel isDisplayTimeInGridItem(boolean isDisplayTimeInGridItem) {
        selectionConfig.isDisplayTimeInGridItem = isDisplayTimeInGridItem;
        return this;
    }
    public PictureSelectionModel isDisplayTimeInPreview(boolean isDisplayTimeInPreview) {
        selectionConfig.isDisplayTimeInPreview = isDisplayTimeInPreview;
        return this;
    }
