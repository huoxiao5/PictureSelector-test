...
public final class PictureSelectionConfig implements Parcelable {
    ...
    public boolean isDisplayTimeInGridItem;
    public boolean isDisplayTimeInPreview;
    ...
    private PictureSelectionConfig(Parcel in) {
        ...
        isDisplayTimeInGridItem = in.readByte() != 0;
        isDisplayTimeInPreview = in.readByte() != 0;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte((byte) (isDisplayTimeInGridItem ? 1 : 0));
        dest.writeByte((byte) (isDisplayTimeInPreview ? 1 : 0));
    ...
    private void initDefaultValue() {
        ...
        isDisplayTimeInGridItem = false;
        isDisplayTimeInPreview = false;
